...
export class TeamList extends Component {
    static displayName = TeamList.name;
    ...
    render() {
        return (
            <div>
                {this.teamList.teams.map(item => (
                    <div class="card mt-3 mb-3">
                        <div class="card-body">
                            <h5 class="card-title">{item.school}</h5>
                            <div class="card-subtitle">The {item.name}</div>
                            <p class="card-text">Location: {item.city}, {item.state}</p>
                        </div>
                    </div>
                ))}
            </div>
